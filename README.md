...
Automatización y Ofimática Avanzada:
Redes, Simulación y Hardware:
Cisco Packet Tracer (Diseño y enrutamiento de redes)
Proteus & Tinkercad (Simulación de circuitos electrónicos y digitales)
Arduino IDE (Programación de microcontroladores y sensores)
<<<<<<<<<<<<<<<<<<<<< Áreas de interés >>>>>>>>>>>>>>>>>>>>>>>>>>
Desarrollo de Software Full-Stack: Creación, optimización y mantenimiento de aplicaciones web modernas, abarcando desde interfaces responsivas e interactivas hasta la lógica de servidores y APIs REST.
Gestión y Arquitectura de Bases de Datos: Modelado de datos, diseño de esquemas relacionales y no relacionales, optimización de consultas complejas y desarrollo de lógica de negocio mediante procedimientos almacenados (PL/SQL).
